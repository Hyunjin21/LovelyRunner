...
const Main04 = () => {
  ...
  useEffect(()=>{
    ...
    .fromTo(textRef.current, {x:'100%'}, {x:'-20%', ease:'none', duration:5},0)
  },[]);
  

  return (
    <section className='w-dvw' style={{backgroundColor:'#ffec40'}}>
        <div className='descript h-dvh' style={{color:'#000', paddingTop:'260px'}}>
          ...
          <div ref={triggerRef} className='scroll-title h-dvh w-dvw flex justify-center items-start' style={{position:'absolute',backgroundColor:'#ffec40', paddingTop:'260px',paddingBottom:'260px'}}>

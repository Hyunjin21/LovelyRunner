...
const Main07 = () => {
  return (
    <section className='w-dvw' style={{backgroundColor:'#fff'}}>
        ...
        <div className='img-scroll flex flex-row' style={{width:'1920px', maxWidth:'1920px'}}>
          <div className='img-wrap' style={{width:'30.208vw', height:'40.521vw', position:'relative', flexShrink:'0 !important'}}>
            <img src='scene1.png' style={{width:'100%',height:'100%', objectFit:'cover',objectPosition:'center'}}/>
          </div>
          <div className='img-wrap' style={{width:'49.323vw', height:'33.906vw', position:'relative', flexShrink:'0 !important'}}>
            <img src='scene2.png' style={{width:'100%',height:'100%', objectFit:'cover',objectPosition:'center'}}/>
          </div>
          <div className='img-wrap' style={{width:'30.052vw', height:'40.990vw', position:'relative', flexShrink:'0 !important'}}>
            <img src='scene3.png' style={{width:'100%',height:'100%', objectFit:'cover',objectPosition:'center'}}/>
          </div>
          <div className='img-wrap' style={{width:'33.698vw', height:'43.073vw', position:'relative', flexShrink:'0 !important'}}>
            <img src='scene4.png' style={{width:'100%',height:'100%', objectFit:'cover',objectPosition:'center'}}/>
          </div>
          <div className='img-wrap' style={{width:'34.635vw', height:'43.750vw', position:'relative', flexShrink:'0 !important'}}>
            <img src='scene5.png' style={{width:'100%',height:'100%', objectFit:'cover',objectPosition:'center'}}/>
          </div>
          <div className='img-wrap' style={{width:'49.375vw', height:'33.906vw', position:'relative', flexShrink:'0 !important'}}>

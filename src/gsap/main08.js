...
const Main08 = () => {
  ...
  return (
    <section
      ref={triggerRef}
      className="scroll-title overflow-x-clip h-screen w-full"
      style={{
        backgroundColor: "#fff",
        width: "100%",
        height: "100vh",
    ...
    >
      ...
      >
        <span
          ...
          style={{ fontSize: "20.833vw", fontWeight: 300, color: "#6abbff" }}
        >
          드라마 배급사
        </span>
      </div>
